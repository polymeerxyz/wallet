...
import { Copy01Icon, Invoice01Icon, MoneyReceive02Icon, RefreshIcon } from "@hugeicons/core-free-icons"
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {(() => {
                            if (status === "Open" && !isExpired && expiresAt > 0) {
                              return (
                                <span className="truncate text-[9px] leading-none font-bold uppercase text-warning">
